...
def run_test():
    url = 'https://apnvtfsmzjlwbdvrxclt.supabase.co'
    key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFwbnZ0ZnNtempsd2JkdnJ4Y2x0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE3OTA1NzUsImV4cCI6MjA5NzM2NjU3NX0.9j8w_dkZkc6G1C6gXXtMfMPaQNrCcgJH0Iva1yBX7CI'
...
test();
"""
    with open(r"e:\PKT Builder\test_insert.mjs", "w", encoding="utf-8") as f:
        f.write(node_code)
    
    os.system(r"node e:\PKT Builder\test_insert.mjs")
